import { CORPORATE_THEME as baseTheme, NbJSThemeOptions, NbJSThemeVariable } from '@nebular/theme';

const baseThemeVariables: NbJSThemeVariable | undefined = baseTheme.variables;
...
export const CORPORATE_THEME: NbJSThemeOptions = {
  ...
  variables: {
    ...
    echarts: {
      ...
      textColor: baseThemeVariables?.fgText,
      axisLineColor: baseThemeVariables?.border5,
